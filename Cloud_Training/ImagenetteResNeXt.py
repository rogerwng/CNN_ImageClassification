...
from utils.ClassificationModel import ResNeXt, initialize_he
...
model = ResNeXt(10,arch_resnext,lr=0.01,momentum=0.9,weight_decay=0.0002) # suggested from literature
...
# checkpoint
torch.save(model.state_dict(),'ImagenetteResNeXt.params')

# val acc 0.695 after 47 epochs