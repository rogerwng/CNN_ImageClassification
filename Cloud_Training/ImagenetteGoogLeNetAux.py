# GoogLeNet with Auxillary classifiers on Imagenette

from utils.Training import train
from utils.Datasets import Imagenette
from utils.ClassificationModel import GoogLeNet_Aux, initialize_he
...
model = GoogLeNet_Aux(10,lr=0.01,momentum=0.9,weight_decay=0.0002) # suggested from literature
